                ...
                <div className="container flex flex-col justify-center p-6 mx-auto sm:py-12 lg:py-24 lg:flex-row lg:justify-between">
                    <div className="flex flex-col justify-center p-6 text-center rounded-sm lg:max-w-md xl:max-w-lg lg:text-left">
                        <h1 className="text-4xl font-bold leading-none sm:text-4xl lg:text-6xl"> <span className="dark:text-amber-600">Web</span>-Tecnology
                            <br /> <p className='py-3 '>Platfrom 2<span className="text-amber-600">0</span>2<span className="text-amber-600">2</span></p>
                        </h1>
                    ...
                    <div className="flex items-center justify-center p-6 mt-8 lg:mt-0 h-69 sm:h-80 lg:h-96 xl:h-112 2xl:h-128">
                        <img src='https://img.freepik.com/free-vector/digital-marketing-team-constructing-landing-home-page-tiny-people-painting-units-webpage-illustration-website-designers-content-managers-internet-promotion-concept-landing-page_74855-17962.jpg?w=996&t=st=1666807296~exp=1666807896~hmac=4e270c66f476986cc56dce543adeb4f9093e3e573a0fc18ae7bf800e4389ec4c' alt="" className="object-contain h-72 sm:h-80 lg:h-96  xl:h-112 2xl:h-128 rounded-full" />
                    </div>
                </div>
            </section>
        </div>
